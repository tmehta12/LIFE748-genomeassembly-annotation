...
There are a few options on systems to use to complete the workshop (Pick 1 option and stick with it - option 1 might be the best but option 2 might be the quickest!):
